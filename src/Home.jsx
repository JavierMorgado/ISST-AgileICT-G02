    ...
    return(
        <div className="vw-100 vh-100" style={{ backgroundImage: `url(${agylelogo})`, backgroundSize: 'contain', backgroundPositionX: 'center', backgroundPositionY: '3rem', backgroundRepeat: 'no-repeat'}}>
            <div className='d-flex justify-content-end align-items-center pt-3 me-3'>
                ...
                <button onClick={goToEmpresa} className='rounded-pill ms-3 me-3 white' style={{backgroundColor: '#002C4B', letterSpacing: '0.5px'}}>Empresa</button>
                <button className='rounded-pill white' style={{backgroundColor: '#D83000', letterSpacing: '0.5px'}}>Profesional</button>
            </div>
