...
export default function RegisterEmpresa(props) {
  ...
  return (
    <div className="d-flex flex-column justify-content-start align-items-center vh-100 vw-100">
      ...
      >
        <h5 className="text-uppercase mb-4">Datos de la empresa</h5>
        ...
        <h6
          className="fw-semibold text-uppercase text-center mt-2 mb-4"
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between w-100 gap-3 mb-4">
          <div
            ...
            className={`rounded-3 p-3 flex-fill text-center border ${
              formData.plan === "Bronce"
                ? "border-warning bg-opacity-100"
                : "bg-opacity-50"
            }`}
          ...
          <div
            ...
            className={`rounded-3 p-3 flex-fill text-center border ${
              formData.plan === "Plata"
                ? "border-secondary bg-opacity-100"
                : "bg-opacity-50"
            }`}
          ...
          >
            ...
            <p className="small mb-0" style={{ color: "black" }}>
              Todo lo anterior <br />+ Eventos de reclutamiento para tu perfil
            </p>
          </div>
        </div>
        <button
